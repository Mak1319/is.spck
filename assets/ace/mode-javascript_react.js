define(
	...
	define(
		"ace/mode/behaviour/javascript_react",
		[
			"require",
			"exports",
			"module",
	...
	define(
		...
		function (e, t, n) {
			...
			var r = e("../lib/oop"),
				...
				JsxBehaviour = e("ace/mode/behaviour/javascript_react").JsxBehaviour,
			...
			r.inherits(c, s),
				function () {
					;(this.lineCommentStart = "//"),
						...
						(this.snippetFileId = "ace/snippets/javascript_react"),
						(this.$id = "ace/mode/javascript_react")
				}.call(c.prototype),
				(t.Mode = c)
		}
	)
;(function () {
	window.require(["ace/mode/javascript_react"], function (m) {
