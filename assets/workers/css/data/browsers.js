	...
	Object.defineProperty(t, "__esModule", { value: !0 }),
		(t.cssData = {
			...
			properties: [
				...
				},
				{
					...
					values: [
						...
						{ name: "none", description: "A value of 'none' counts as an image layer but draws nothing." },
						{
							name: "scroll",
							description:
				...
				{
					name: "clip",
					values: [{ name: "auto", description: "The element does not clip." }, { name: "rect()" }],
					syntax: "<shape> | auto",
					description:
				...
				},
				{
					name: "column-fill",
					browsers: ["E12", "FF52", "C"],
					values: [{ name: "auto", description: "Fills columns sequentially." }, { name: "balance" }],
				...
				},
				{
					...
					browsers: ["E16", "FF52", "S10.1", "C57", "O44"],
					values: [{ name: "none", description: "The grid container doesn’t define any named grid areas." }],
					syntax: "none | <string>+",
					description:
				...
				},
				{
					name: "motion-path",
					browsers: ["C46", "O33"],
					values: [{ name: "none", description: "No motion path gets created." }, { name: "path()" }],
				...
				},
				{
					...
					browsers: ["E", "IE10"],
					values: [{ name: "none", description: "The element is not zoomable." }, { name: "zoom" }],
					status: "nonstandard",
					syntax: "none | zoom",
				...
				{ name: "-ms-grid-columns", browsers: ["E", "IE10"], description: "Lays out the columns of the grid." },
				{
				...
				{ name: "-ms-grid-rows", browsers: ["E", "IE10"], description: "Lays out the columns of the grid." },
				{
				...
				},
				{
					...
					browsers: ["E", "IE10"],
					values: [{ name: "grippers" }, { name: "none", description: "Grippers are always off." }],
					status: "nonstandard",
				...
				},
				{
					...
					values: [{ name: "auto", description: "Scrolls in an instant fashion." }, { name: "smooth" }],
					syntax: "auto | smooth",
					description:
				...
				},
				{
					name: "shape-outside",
					browsers: ["FF62", "S10.1", "C37", "O24"],
					values: [{ name: "margin-box" }, { name: "none", description: "The float area is unaffected." }],
				...
				},
				{
					...
					values: [{ name: "flat" }, { name: "preserve-3d", browsers: ["E12", "FF16", "S", "C12", "O15"] }],
				...
				{ name: "-webkit-padding-start", browsers: ["C", "S3"], restrictions: ["percentage", "length"] },
				{
				...
				{ name: "margin-block", syntax: "<'margin-left'>{1,2}", browsers: ["FF66", "C69"], description: "" },
				{ name: "margin-inline", syntax: "<'margin-left'>{1,2}", browsers: ["FF66", "C69"], description: "" },
				{
					name: "mask",
					syntax: "<mask-layer>#",
					browsers: ["E12", "FF2", "S4", "C1", "O"],
					description:
						"The mask CSS property alters the visibility of an element by either partially or fully hiding it. This is accomplished by either masking or clipping the image at specific points.",
				},
				{
				...
				{ name: "padding-block", syntax: "<'padding-left'>{1,2}", browsers: ["FF66", "C69"], description: "" },
				{ name: "padding-inline", syntax: "<'padding-left'>{1,2}", browsers: ["FF66", "C69"], description: "" },
				{
					name: "place-content",
			...
			atDirectives: [
				...
				{ name: "@counter-style", browsers: ["FF33"], description: "Defines a custom counter style." },
				{
					name: "@font-face",
					description:
